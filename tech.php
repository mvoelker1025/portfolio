	...
	<head>
		...
		$(document).ready(function(){
			...
			$('.cad_modal').paulund_modal_box({
				...
				description: 'For another class project, I modeled a 1966 Corvette using Solid Works. With little knowledge of the functions within the 3D modeling software, I learned as I went making in total 12 different revisions of the model.<br></br>'
			});
			...
			$('.cat_modal').paulund_modal_box({
				title: 'CAT Sales Scenario',
				description: 'For our personal selling course, our team of three created a role-playing scenario to sell a CAT Hydraulic Excavator to the CAT sales team. It was a great learning experience to broaden my communication skills in order to close the deal.<br></br><a href="http://issuu.com/michellevoelker/docs/cat_sales_scenario/0">Click here</a> to view our report. <br></br>'
			});
			$('.vic_modal').paulund_modal_box({
